      ...
      <section className="pt-[140px] pb-20 bg-[#0B0B12]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">What We&apos;ve Built.</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex flex-col md:flex-row">
              <div className="p-5 sm:p-8 md:p-12 md:w-1/2 flex flex-col justify-center">
                <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-white">BharatSaver</h2>
              ...
              <div className="md:w-1/2 bg-gradient-to-br from-[#1C1C2E] to-[#13131F] border-t md:border-t-0 md:border-l border-[#1C1C2E] p-8 md:p-12 flex items-center justify-center min-h-[200px] sm:min-h-[260px] md:min-h-[300px]">
                ...
                <div className="relative z-10 font-display text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight">
